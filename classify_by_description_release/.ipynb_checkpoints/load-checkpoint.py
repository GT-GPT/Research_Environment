...
hparams['before_text'] = "A photo of "
...
def generate_gpt_descriptions(hparams):
    ...
    return gpt_descriptions, label_to_classname, n_classes
...
def compute_description_encodings(model,gpt_descriptions):
    ...
    for k, v in gpt_descriptions.items():
        ...
        #print(description_encodings[k])
    return description_encodings

def compute_label_encodings(model,label_to_classname):
...
def show_from_indices(indices, images, label_to_classname, labels=None, predictions=None, predictions2 = None, n=None, image_description_similarity=None, image_labels_similarity=None):
...
def show_misclassified_images(images, labels, label_to_classname, predictions, n=None, 
