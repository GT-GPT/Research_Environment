...
#openai.api_key = 'asdf' #FILL IN YOUR OWN HERE
...
def generate_prompt(category_name: str):
    ...
    return templates['two_shot_detailed_one_features'] + f"""Q: What are useful visual features for distinguishing a {category_name} in a photo?
A: There are several useful visual features to tell there is a {category_name} in a photo:
- """
...
obtain_descriptors_and_save('imagenet_object_2_feature_1_detailed', openai_imagenet_classes)
